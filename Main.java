...
/** The main method instantiates a main class, which includes giving you a choice of things to do.
...
**/
  ...
  public void actionPerformed( ActionEvent e ) {
	  ...
	  case 1:
			  PrintGraph dA = new PrintGraph( inputFile, g );
	  		break;
		  
	  	case 2:
	  		DFS dB = new DFS( inputFile, g );
	  		break;
			  
	  	case 3:
	  		ShortestPathFinder dC = new ShortestPathFinder( inputFile, g );
	  		break;
